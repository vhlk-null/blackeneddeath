...
namespace UserContent.Infrastructure.Migrations
{
    ...
    [Migration("20260502193945_AddSortOrderToFavoritesAndCollections")]
    partial class AddSortOrderToFavoritesAndCollections
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserContent.Domain.Models.AlbumCommentReaction", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
                    ...
                    b.ToTable("album_comment_reactions", (string)null);
                });
            ...
            modelBuilder.Entity("UserContent.Domain.Models.BandCommentReaction", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
                    ...
                    b.ToTable("band_comment_reactions", (string)null);
                });
            ...
            modelBuilder.Entity("UserContent.Domain.Models.AlbumCommentReaction", b =>
                {
                    b.HasOne("UserContent.Domain.Models.AlbumComment", "Comment")
                        .WithMany("Reactions")
                    ...
                    b.HasOne("UserContent.Domain.Models.UserProfileInfo", "User")
                        .WithMany("AlbumCommentReactions")
            ...
            modelBuilder.Entity("UserContent.Domain.Models.BandCommentReaction", b =>
                {
                    b.HasOne("UserContent.Domain.Models.BandComment", "Comment")
                        .WithMany("Reactions")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UserContent.Domain.Models.UserProfileInfo", b =>
                {
                    b.Navigation("AlbumCommentReactions");

                    b.Navigation("BandCommentReactions");
