...
public class UserContentServiceTests
{
    ...
    public UserContentServiceTests()
    {
        ...
        _sut = new UserContentService(_repoMock.Object, _storageMock.Object, Mock.Of<IStorageUrlResolver>(), _httpContextAccessorMock.Object, NullLogger<UserContentService>.Instance);
    }
