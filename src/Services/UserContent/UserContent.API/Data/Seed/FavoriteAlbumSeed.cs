        ...
        public static List<FavoriteAlbum> GetFavoriteAlbums()
        {
            return new List<FavoriteAlbum>
            {
                ...
                new FavoriteAlbum
                {
                    ...
                    AlbumId = SeedConstants.LibraryAlbums.TransilvanianHunger,
                ...
                {
                    UserId = SeedConstants.Users.MetalHead666,
                    AlbumId = SeedConstants.LibraryAlbums.Filosofem,
                ...
                new FavoriteAlbum
                {
                    ...
                    AlbumId = SeedConstants.LibraryAlbums.NightsideEclipse,
                ...
                {
                    UserId = SeedConstants.Users.DarkSoulFan,
                    AlbumId = SeedConstants.LibraryAlbums.DeMysteriis,
                ...
                new FavoriteAlbum
                {
                    ...
                    AlbumId = SeedConstants.LibraryAlbums.TheSatanist,
